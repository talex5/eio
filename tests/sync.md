...
# let () =
    ...
    let a = fork (fun () -> Tracing.label "a"; Semaphore.acquire sem; incr running) in
    let b = fork (fun () -> Tracing.label "b"; Semaphore.acquire sem; incr running) in
    let c = fork (fun () -> Tracing.label "c"; Semaphore.acquire sem; incr running) in
    let d = fork (fun () -> Tracing.label "d"; Semaphore.acquire sem; incr running) in
...
# let () =
    ...
    Fiber.fork ~sw (fun () -> Tracing.label "a"; Semaphore.acquire sem);
    Fiber.fork ~sw (fun () -> Tracing.label "b"; Semaphore.acquire sem);
