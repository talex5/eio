...
type _ Effect.t +=
  ...
  | Socket_of_fd : Switch.t * bool * Unix.file_descr -> Net.stream_socket Effect.t
  | Socketpair : Switch.t * Unix.socket_domain * Unix.socket_type * int ->
      (Net.stream_socket * Net.stream_socket) Effect.t
